...
if [ -z "${1}" ]; then
  echo
  echo "Usage: $0 <sato-base-dir> [<extra-bdb-configure-flag> ...]"
  echo
  echo "Must specify a single argument: the directory in which db4 will be built."
  echo "This is probably /home/USERNAME/sato/ if thats where the root of the SATO repository is saved."
  echo "RUN: ./install_db4.sh /home/USERNAME/sato/"
  echo
  exit 1
fi
...
echo 'When compiling SATO, run `./configure` in the following way:'
echo
